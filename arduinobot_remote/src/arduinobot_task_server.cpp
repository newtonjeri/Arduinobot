...
{
class ArduinobotTaskServer : public rclcpp::Node
{
public:
  explicit ArduinobotTaskServer(const rclcpp::NodeOptions& options = rclcpp::NodeOptions())
    : Node("task_server", options)
  {
    ...
    action_server_ = rclcpp_action::create_server<arduinobot_msgs::action::ArduinobotTask>(
        this, "task_server", std::bind(&ArduinobotTaskServer::goalCallback, this, _1, _2),
        std::bind(&ArduinobotTaskServer::cancelCallback, this, _1),
        std::bind(&ArduinobotTaskServer::acceptedCallback, this, _1));
  }
...
private:
      ...
      const std::shared_ptr<rclcpp_action::ServerGoalHandle<arduinobot_msgs::action::ArduinobotTask>> goal_handle)
  {
    ...
    std::thread{ std::bind(&ArduinobotTaskServer::execute, this, _1), goal_handle }.detach();
  }
...
RCLCPP_COMPONENTS_REGISTER_NODE(arduinobot_remote::ArduinobotTaskServer)